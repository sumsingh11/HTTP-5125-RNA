...
namespace CumulatievePart1.Controllers
{
    ...
    public class TeacherAPIController : ControllerBase
    {
        ...
        /// <summary>
/// This method update an existing teacher in the database. The teacher's updated information is provided 
/// in the `TeacherData` object, and the teacher's ID is passed as part of the request query.
/// </summary>
/// <param name="TeacherData"> object containing the updated details of the teacher</param>
/// <param name="TeacherId"> unique identifier (primary key) of the teacher to be updated</param>
/// <example>
...
///     "TeacherSalary": 55000
/// }
/// This request will update the teacher with ID 4, setting the new values for the teacher's first name, last name,
/// hire date, employee number, and salary.
/// </example>
/// <returns>
/// The updated `Teacher` object after the database has been modified.
/// </returns>
    ...
    // Open a connection to the database, automatically closing it when done
                using (MySqlConnection Connection = _context.AccessDatabase())
            {
                Connection.Open();
        ...
        // Preparing the query with parameters to prevent SQL injection
        ...
        // Set the teacher ID for the record to be updated
                Command.Parameters.AddWithValue("@id", TeacherId);

                Command.ExecuteNonQuery();
            }
    // Retrieve and return the updated teacher details after the update
            return FindTeacherDetail(TeacherId);
        }
    }
